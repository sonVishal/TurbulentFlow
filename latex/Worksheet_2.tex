...
\begin{itemize}
	...
	In order to take different cell sizes into account when evaluating the derivatives and interpolated values for the F, G, H calculations, the velocity and turbulent viscosity components have to be considered proportionally to their distance to the point of interest (i.e. to the point where the value are evaluated). 
	\td{}
\end{itemize}
